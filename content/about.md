...
The Estate Watch website is now maintained as an open-source project and is being kept up to date by voluntary contributors via its Github interface. If you would like to get involved then read our <a href="/guide/"> Guide</a> on how to submit edits for review via Github. The list with raw data on our estates under threat can be downloaded in CSV format <a href="/estates.csv">here.</a>
</div>	
