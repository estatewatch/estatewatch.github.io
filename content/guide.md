...
Through the power of<a href="https://pages.github.com/"> Github</a> anyone can edit this website. The first step to getting involved is to sign up for a (free) github account at <a href="https://github.com/signup"> https://github.com/signup</a>.
</div>
...
To begin editing you will first need to be logged in to Github. Next, navigate to the page on the Estate Watch website you want to edit and click the _'edit this page on Github'_ link at the bottom of the page:
...
Once you have been redirected to the source text page, you will see a page like the one below. Next, click on the pencil icon at the top right of the page to enter editing mode:<img src="estates/src/images/github-edit.png" alt="github edit image">
...
This guide shows for example, how to insert hyperlinks:

![Github Hyperlinks](estates/src/images/githubhyperlinks.png)

When you have finished editing, you can review what the page will look like by clicking on the 'Preview' button. If you are happy with the changes, click the green 'Commit Changes' button: <img src="estates/src/images/github-commit-changes.png" alt="github button">

Next click the 'Propose Changes' button <img src="estates/src/images/github-propose-changes.png" alt="propose changes">  and then the 'Create Pull Request' buttons. <img src="estates/src/images/github-create-pull-request.png" alt="create pull request">

This will submit your changes for review by an administrator before being published.
